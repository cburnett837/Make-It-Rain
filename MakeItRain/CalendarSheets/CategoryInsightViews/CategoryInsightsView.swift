...
//    //@State private var navPath: Array<CivNavDest> = []
...
//        #endif
//        .toolbar { toolbar }
//        .navigationDestination(for: CivNavDest.self) { dest in
//            switch dest {
//            case .monthList:
...
//                
//                if trans.count > 0 {
//                    let cost = TransactionHelper.getSpendMinusIncome(from: trans)
//                    CivFakeNavLink {
//                        VStack(alignment: .leading) {
...
//                )
//            }
//            let transactions = TransactionHelper.getIncomeTransactions(from: monthlyTrans)
//            let moneyIn = TransactionHelper.getIncome(from: monthlyTrans)
//            let cashOut = TransactionHelper.getDebitSpend(from: monthlyTrans)
//            let totalSpend = TransactionHelper.getSpend(from: monthlyTrans)
//            let actualSpend = TransactionHelper.getSpendMinusIncome(from: monthlyTrans)
//            
...
//            navPath.append(CivNavDest.transactionList)
//        } else {
//            navPath.append(CivNavDest.monthList)
//        }
//    }
//    
//    
...
//                let appSuiteBudgets = await budgetModel.appSuiteBudgets
//                
