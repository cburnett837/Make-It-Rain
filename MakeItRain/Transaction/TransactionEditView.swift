...
//
//
//struct TransactionEditViewNEW: View {
////    @Observable
////    class ViewModel {
////        var hoverPic: CBPicture?
////        var deletePic: CBPicture?
...
//            alteredBy
//        } header: {
//            SheetHeaderView(title: title, trans: trans, focusedField: $focusedField, showDeleteAlert: $showDeleteAlert, isTemp: isTemp)
//        } footer: {
//            if let linkedLingo {
//                Text(linkedLingo)
//                   .font(.caption2)
...
//        /// Grab the transaction from the model or create a new one.
//        /// 2/12/25 now passed in to the view
//        //trans = calModel.getTransaction(by: editTrans!, from: isTemp ? .tempList : transLocation)
//            
//        /// Determine the title button color.
//        titleColorButtonHoverColor = trans.color == .primary ? .gray : trans.color
//        /// Set the transaction date to the date of the passed in day.
