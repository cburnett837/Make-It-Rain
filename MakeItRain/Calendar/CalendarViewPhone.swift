                            ...
                            ScrollView {
                                LazyVGrid(columns: sevenColumnGrid, spacing: 0) {
                                    ForEach($calModel.sMonth.days) { $day in
                                        VStack(spacing: 0) {
                                            DayViewPhone(transEditID: $transEditID, day: $day, selectedDay: $selectedDay, showTransferSheet: $showTransferSheet, putBackToBottomPanelViewOnRotate: $putBackToBottomPanelViewOnRotate, overviewDay: $overviewDay)
