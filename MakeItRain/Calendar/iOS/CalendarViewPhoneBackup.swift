...
//
//#if os(iOS)
//struct CalendarViewPhoneBackup: View {
...
//    @Namespace var newTransactionMenuButtonNamespace
//    
...
//        }
//        
//        /// ORIGINAL SEARCH CODE BEFORE USING SEARCHABLE WITH LIQUID GLASS - 9-24-25
////        ToolbarItemGroup(placement: .topBarTrailing) {
////            @Bindable var calModel = calModel
////            HStack(spacing: 20) {
////                if (!showSearchBar && AppState.shared.isIpad) || !AppState.shared.isIpad {
