...
extension StandardUITextField {
    ...
    func cbKeyboardType(_ type: CBKeyboardType) -> StandardUITextField {
        var view = self
...
struct UITextFieldWrapper</*Keyboard: View, */Toolbar: View>: UIViewRepresentable {
    var placeholder: String
    @Binding var text: String
    var onSubmit: (() -> Void)?
    var onClear: (() -> Void)?
    ...
    private var maxLength: Int?
    private var startCursorAtEnd: Bool = false
    //private var customKeyboardType: CustomKeyboardType?
    ...
    init(
        ...
        onClear: (() -> Void)? = nil,
        onBeginEditing: (() -> Void)? = nil,
        //@ViewBuilder keyboard: @escaping () -> Keyboard? = { EmptyView() },
        @ViewBuilder toolbar: @escaping () -> Toolbar? = { EmptyView() }
    ) {
        self.placeholder = placeholder
        self._text = text
...
//    func sizeThatFits(_ proposal: ProposedViewSize, uiViewController: UIHostingController<Keyboard>, context: Context) -> CGSize? {
...
//    }
    ...
    func makeUIView(context: Context) -> UITextField {
        ...
        if case .custom(let customType) = keyboardType {
            switch customType {
            case .numpad:
...
//        if let customKeyboardType = self.customKeyboardType {
...
//
//
//struct UITextFieldWrapperOG<Toolbar: View>: UIViewRepresentable {
//    var placeholder: String
//    @Binding var text: String
//    var onSubmit: (() -> Void)?
//    var onClear: (() -> Void)?
...
extension UITextFieldWrapper {
    ...
    func uiKeyboardType(_ type: CBKeyboardType) -> UITextFieldWrapper {
        var view = self
        view.keyboardType = type
//        switch type {
//        case .system(let systemType):
//            view.keyboardType = systemType
//        case .custom(let customType):
//            view.customKeyboardType = customType
//        }
                
        return view
    }
    
//    func uiKeyboardType(_ type: CustomKeyboardType) -> UITextFieldWrapper {
//        var view = self
//        view.customKeyboardType = type
//        return view
//    }
...
//    var toolbar: () -> Toolbar?
//    
//    init(placeholder: String, text: Binding<String>, @ViewBuilder toolbar: @escaping () -> Toolbar? = { EmptyView() }) {
//        self.placeholder = placeholder
//        self._text = text
//        self.toolbar = toolbar
//    }
