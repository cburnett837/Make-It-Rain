...
class EventIdModel: Decodable {
    ...
    let items: Array<EventItemIdModel>?
    
    enum CodingKeys: CodingKey { case event_id, participant_ids, items }
    ...
    required init(from decoder: Decoder) throws {
        ...
        items = try container.decodeIfPresent(Array<EventItemIdModel>.self, forKey: .items)
    }
}
